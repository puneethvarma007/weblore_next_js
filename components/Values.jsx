...
//       {/* Grid Container */}
//       <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-6 gap-6 w-full h-[800px]">
...
//          {/* Item 4: Stewardship */}
//          <div
//           className="md:col-span-3  md:left-[10%] md:row-span-4 bg-cover bg-center rounded-lg relative"
