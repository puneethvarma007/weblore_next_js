...
export default function OurStory() {
  return (
    <section id='our-story' className="relative py-16 px-4 md:px-8">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <p className="mb-4 bg-gradient-to-r from-yellow-400 to-gray-500 text-transparent bg-clip-text">
        ...
        <p className="bg-gradient-to-r from-yellow-400 to-gray-500 text-transparent bg-clip-text">
